      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-4">Join StorySphere</h1>
            <p className="text-gray-600 mt-2">Start your writing journey today</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/70 text-gray-500">Already have an account?</span>
            </div>
          </div>
